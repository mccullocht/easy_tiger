    ...
    D: VectorStore<Elem = f32> + Send + Sync,
{
    ...
    fn insert_all<P: Fn(u64) + Send + Sync>(&self, progress: P) -> Result<()> {
        ...
        //let mut order = (0..self.limit).collect::<Vec<_>>();
        // XXX shuffling the order slows everything down but makes the graph not dogshit.
            ...
            .try_for_each(|v| {
                ...
                loop {
                    ...
                    for e in edges.iter() {
                        ...
                        //if e.vertex() == 2 {
                        //    println!(
                        //        "    add backlink and prune {:?}",
                        //        Neighbor::new(v as i64, e.distance())
                        //    );
                        //}
    ...
    fn search_for_insert(
        ...
        // XXX
        //if vertex_id == 2 {
        //    println!("  initial candidates {vertex_id} {candidates:?}");
        //}
        ...
        // XXX
        //if vertex_id == 2 {
        //    println!("  pruned candidates {vertex_id} {candidates:?}");
        //}
        Ok(candidates)
    }
    ...
    fn insert_in_flight_edges_from(
        ...
        // XXX
        //if vertex_id == 2 {
        //    println!("  with in flight edges {vertex_id} {:?}", *edges);
        //}
    ...
    fn prune_and_apply<T>(
        ...
        for e in pruned_edges.into_iter().rev() {
            ...
            if iv.len() > max_edges.get() || ev.len() > max_edges.get() {
                ...
                // XXX removing this makes the graph directed.
