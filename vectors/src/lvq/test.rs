...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 2.5226507,
        residual_error_term: 0.26611328,
...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 1.5514041,
        residual_error_term: 0.34301758,
...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 2.5226507,
        residual_error_term: 0.046966553,
...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 1.5514041,
        residual_error_term: 0.06185913,
...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 2.5226507,
        residual_error_term: 0.0029773712,
...
tlvq_coder_test!(
    ...
    PrimaryVectorHeader {
        l2_norm: 1.5514041,
        residual_error_term: 0.003566742,
