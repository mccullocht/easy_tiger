pub mod avx512 {
    use std::arch::x86_64::{
        ...
        _mm512_castps_si512, _mm512_castsi512_ps, _mm512_cvtepi8_epi32, _mm512_cvtepi32_epi8,
        _mm512_fmadd_ps, _mm512_loadu_ps, _mm512_maskz_loadu_ps, _mm512_popcnt_epi32,
    ...
    #[target_feature(enable = "avx512f")]
    #[inline]
    pub unsafe fn decode(v: &[u8], magnitude: f32, out: &mut [f32]) {
    ...
    unsafe fn unpack_group<const N: u32, const SHIFT: u32>(v: __m512i, m: __m512, o: *mut f32) {
        unsafe {
            ...
            let ups = _mm512_castsi512_ps(r);
            _mm512_storeu_ps(o.add(N as usize * 16), ups);
        }
    }
}
